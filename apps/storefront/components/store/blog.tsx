...
import type { BlogListPageProps, BlogPostPageProps } from '@mcloud/themes/types'
...
const LIST_THEMES = {
    classic: dynamic(() => import('@mcloud/themes/classic/BlogListPage'), { ssr: false, loading: Spinner }),
...
const POST_THEMES = {
    classic: dynamic(() => import('@mcloud/themes/classic/BlogPostPage'), { ssr: false, loading: Spinner }),
