    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <section className="relative overflow-hidden">
                <div className="relative flex flex-col sm:flex-row items-start gap-6">
                    ...
                    <img
                        ...
                        alt=""
                        aria-hidden="true"
                        className="w-80 sm:w-72 h-auto shrink-0 select-none hidden md:block"
                    />
                </div>
            </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3">
                {[
                    { label: 'Servers', value: serverList.length, icon: 'dns', href: `/org/${orgSlug}/servers` },
            ...
            <section className="space-y-3">
                ...
                <div className="divide-y divide-[var(--md-sys-color-outline-variant)]/50 overflow-hidden">
